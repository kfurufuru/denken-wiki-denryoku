...
| 年度 | 問番号 | 難易度 | 内容 |
|------|--------|--------|------|
| 2023（R5）上期 | 問9 | 中 | CVケーブルとOFケーブルの特性比較（誘電損・最高使用温度） |
| 2022（R4）上期 | 問9 | やや難 | 地中ケーブルの充電電流計算（静電容量・線路長・電圧から算出） |
| 2021（R3）下期 | 問9 | 中 | 架空送電線と地中ケーブルの特性比較（L・C・フェランチ効果） |
| 2020（R2） | 問9 | 中 | CVケーブルの構造（各層の名称と役割の正誤判定） |
| 2019（R1） | 問8 | 中 | 地中送電の特徴（建設費・保守・事故復旧・充電電流の比較） |
