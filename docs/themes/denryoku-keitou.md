...
| 年度 | 問番号 | 難易度 | 内容 |
|------|--------|--------|------|
| 2023（R5）上期 | 問10 | 中 | 系統周波数と需給バランスの関係（正誤判定形式） |
| 2022（R4）下期 | 問10 | やや難 | 設備利用率の計算と供給予備率の計算 |
| 2021（R3）上期 | 問10 | 中 | 揚水発電の仕組みと需給調整への活用（知識問題） |
| 2020（R2） | 問10 | 中 | 系統連系規程のポイント（単独運転防止・逆潮流の正誤判定） |
| 2019（R1） | 問10 | やや難 | 負荷持続曲線の読み方とベース・ミドル・ピーク負荷の概念 |
