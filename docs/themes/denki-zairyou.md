...
| 年度 | 問番号 | 難易度 | 内容 |
|------|--------|--------|------|
| 2023（R5）下期 | 問7 | 中 | ACSRの構造と特性（外層アルミ・鋼芯の役割） |
| 2022（R4）上期 | 問8 | 中 | 絶縁材料の耐熱クラスと最高使用温度（正誤判定） |
| 2021（R3）上期 | 問7 | やや難 | 導電材料の導電率・比重・引張強さの比較（銅・アルミ・鋼） |
| 2020（R2） | 問7 | 中 | 珪素鋼板の特性（珪素含有量と鉄損・機械的強度の関係） |
| 2019（R1） | 問9 | 中 | SF6ガスの特性（絶縁性・消弧性・化学的性質・環境特性） |

> **出題傾向まとめ**: 銅・アルミの導電率比較（「約60%」）と比重比較は最頻出。絶縁クラス（B=130℃、F=155℃、H=180℃）の数値は毎回といっていいほど問われる。ACSRの構造（外層アルミ・中心鋼）とその理由（軽量＋強度）は知識問題の定番。SF6の特性（無毒・高温暖化係数・高絶縁性）も頻出。
