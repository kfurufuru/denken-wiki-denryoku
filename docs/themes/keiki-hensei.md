...
| **コンデンサ形 VT（CVT）** | コンデンサ分圧＋誘導性結合 | 特別高圧〜超高圧 (66 kV 以上) | 鉄心 VT より絶縁設計が容易 |
...
!!! note "R08 予測"
    R03・R05 上・R06 下 と問 7 での出題実績が厚く（連続ではないが頻出）、計器用変成器は問 7 の定番論点。R08 でも **取扱い注意（開放禁止／短絡禁止／接地）** の穴埋・論説が継続出題される見込み。
